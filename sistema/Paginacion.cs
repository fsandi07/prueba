...
public class Paginacion<T> : List<T>
{
    ...
    public bool HasPreviousPage // para activar los botones estan relacionado en el index es para que vea si 
        //puede rertrocer o no la pagina
    {
        get
        {
            return (PageIndex > 1);
    ...
    public bool HasNextPage // determina si existe una pagina siguiente 
    {
        get
        {
